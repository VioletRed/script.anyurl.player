...
function add_play_on_xbmc_buttons(clip) {
	...
	xbmc_stop.setAttribute('title', 'Queue video');
...
/*
 * ============================================================================
 * Example of site dependent code here!!!!
 * ============================================================================
 */

/*encode_video_url will create the proper "file" parameter
 * in json for XBMC
 */ 
...
//}
//
/* Here comes the integration code:
